...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Create Canary e2e-create-mu31hwgj-dvwih0-test",
        short_name: "Create Canary e2e-create-mu31hwgj-dvwih0-test",
        description: "Create Canary e2e-create-mu31hwgj-dvwih0-test — free forever",
        start_url: "/",
        display: "standalone",
